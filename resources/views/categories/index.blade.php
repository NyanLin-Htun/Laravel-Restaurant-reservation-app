        ...
        <div class="grid lg:grid-cols-4 gap-y-6">
            ...
            <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                ...
                <div class="px-6 py-4">
                  ...
                  <a href="{{ route('categories.show', $category->id ) }}"><h4 class="mb-3 text-xl font-semibold tracking-tight text-green-600 uppercase hover:text-green-400">{{ $category->name }}</h4></a>
