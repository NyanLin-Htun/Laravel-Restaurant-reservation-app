                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 font-sm font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                <div class="flex space-x-2">
                                    ...
                                    <form action="{{ route('admin.menus.destroy', $menu->id) }}" class="px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white" method="POST" onsubmit="return confirm('Are you sure?');">
                                    @csrf
                                    @method('DELETE')
